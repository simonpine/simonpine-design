                        ...
                        {({ total, clear }) => {
                            ...
                            return (
                                <div className='confirmation'>
                                    ...
                                    <div className='k cartOpt'>
                                        {/* <Link to={{ pathname: "/order", }} className="clear l marginB" >Look other orders</Link> */}
                                        <button className='clear l marginB' onClick={() => { clearAll() }}>Clear cart</button>
                                        <Link to={{ pathname: "/cart/checkout" }} className='clear marginB'>Checkout</Link>
                                    </div>
                                </div>
                            )
                        }}
